export default function Button(props: {
  ...
  return (
    <button
      ...
      type="submit"
      className={`${props.color} ${props.bgcolor} font-montserrat rounded p-3.5 text-sm shadow  relative inline-flex items-center justify-start overflow-hidden transition-all rounded hover:bg-white group ${props.opacity} ${props.width}`}
    >
      {/* purple box */}
