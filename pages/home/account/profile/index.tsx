            ...
            >
              ...
              <div className="flex flex-col lg:pt-1 md:flex-row">
                <div className="flex flex-1 ">
                  <div className="w-full mx-auto md:mx-2 ">
                    <label className=" text-sm font-normal text-gray-600">
                      Country
                    </label>
                    <div
                      className={`bg-white  p-1 flex border border-gray-200 
                     rounded `}
                    >
                      <input
                        value={country}
                        onChange={(e) => setCountry(e.target.value)}
                        className="w-full py-2 px-2 text-gray-700 outline-none appearance-none"
                        autoComplete="text"
                        required
                      />{" "}
                    </div>
                ...
                <div className="flex-1 w-full md:ml-3 ">
                  <label className=" text-sm font-normal text-gray-600">
                    Date of Birth
                  </label>
                  <div className="">
