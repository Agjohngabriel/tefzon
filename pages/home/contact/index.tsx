...
const Index = () => {
  return (
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-base text-2xl font-medium text-body-color leading-relaxed mb-9 mx-5">
                            Based in <span className="font-bold font-bold italic">America</span>, available worldwide.
                        </p>
	...
	<div
		...
		<p className="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Stay up to date and move work forward with
