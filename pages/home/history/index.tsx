          ...
          <div className={openTab === 1 ? "block mx-auto " : "hidden"}>
            ...
            <div className="bg-gradient-to-br from-[#FFFFFF]/100 via-[#F2F6FF]/50 to-[#E5ECFA]/100 rounded-3xl border shadow-2xl p-2 sm:p-10 pb-5 max-w-4xl ">
              <div className="mb-10">
                ...
                <div className="w-full md:w-[40rem] flex flex-col p-2 border border-[#94A3B8] bg-white shadow-md hover:shodow-lg rounded-lg mb-5">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between ">
                    <div className="flex justify-between justify-center space-x-3  sm:space-x-4  items-center">
                      <p className="rounded-lg font-[Oswald] text-2xl  p-2  text-[#240155] bg-[#795DE029]">
                        ...
                        >
                          <path
                            d="M28.48 0.695312C12.7762 0.695312 0 12.4279 0 26.8495C0 41.2711 12.7762 53.0036 28.48 53.0036C44.1838 53.0036 56.96 41.2711 56.96 26.8495C56.96 12.4279 44.1838 0.695312 28.48 0.695312ZM28.48 52.7374C12.9359 52.7374 0.289861 41.1241 0.289861 26.8495C0.289861 12.5748 12.9359 0.961502 28.48 0.961502C44.0241 0.961502 56.6701 12.5748 56.6701 26.8495C56.6701 41.1241 44.0241 52.7374 28.48 52.7374Z"
                            fill="#240155"
                          />
                          <path
                            d="M28.4804 2.14844C13.648 2.14844 1.58105 13.2299 1.58105 26.8511C1.58105 40.4722 13.648 51.5537 28.4804 51.5537C43.3129 51.5537 55.3801 40.4722 55.3801 26.8511C55.3801 13.2299 43.3129 2.14844 28.4804 2.14844Z"
                            fill="#240155"
                          />
                          <path
                            d="M30.7521 13.4141V20.704H34.4877V25.577H30.7521V35.3229H34.4877V40.1959H27.356C26.79 40.1959 26.2948 40.0075 25.8703 39.6306C25.4458 39.2538 25.2335 38.8055 25.2335 38.2857V25.577H22.6016V20.704H25.2335V13.4141H30.7521Z"
                            fill="white"
                          />
                        </svg>
                      </p>
