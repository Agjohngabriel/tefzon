  ...
  return (
    <MainLayout>
      <div className="py-4">
        ...
        <div className="max-w-sm sm:max-w-4xl bg-gradient-to-br from-[#FFFFFF]/100 via-[#F2F6FF]/50 to-[#E5ECFA]/100 border-inherit rounded-xl shadow-2xl shadow-indigo-500/50 md:ml-20 px-5 sm:px-10 py-5 my-5 items-center justify-center w-auto">
          <button
            onClick={goBack}
