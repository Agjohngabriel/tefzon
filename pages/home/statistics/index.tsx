...
<div className="px-1">
    ...
    <div className="-mb-20 -translate-y-1/2 transform">
      <img src="https://i.ibb.co/JWTX98g/Seek-Png-com-kobe-bryant-png-109287.png" alt="Kobe Bryant" title="Kobe Bryant" className="mx-auto h-64" />
    </div>
    ...
    <div className="text-center">
      <button className="rounded-xl bg-black px-24 py-2 text-white">Select player</button>
    </div>
  </div>
    </MainLayout>
  );
