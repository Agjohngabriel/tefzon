      ...
      <div className=" container max-w-6xl bg-gradient-to-br from-[#FFFFFF]/100 via-[#F2F6FF]/50 to-[#E5ECFA]/100 border-inherit rounded-xl shadow-2xl shadow-indigo-500/50 mx-auto mt-10 mb-20  px-4 py-6 lg:px-10  w-auto">
        <div className="w-full md:w-5/5 mx-auto p-2">
          ...
          <p className="text-sm font-normal text-gray-600 my-3">
            ...
            shall mean the TEFZON Limited.
          </p>

          <p className="text-sm font-normal text-gray-600 my-3">
            This website, <Link href="/">www.tefzon.com</Link> (the “Website”),
            and the Tefzon mobile application (the “App”) are operated by the
            TEFZON Limited, a company registered in Nigeria under company number
            1850714 with registered at Block 14, No 3 Praisehill Estate, Lagos
            Nigeria. Our TAX number is 24038283.
          </p>
          <p className="text-sm font-normal text-gray-600 my-3">
          ...
          <div className="shadow-md">
            <div className="tab w-full overflow-hidden border-t">
              ...
              <div className="tab-content overflow-hidden border-l-2 bg-gray-100 border-indigo-500 leading-normal">
                <p className="px-5 pb-3 pt-5">
                  If you are under 18, you may need your parent/guardian to help
                  you with your use of the Website and the App and with reading
                  these Terms and Conditions. If anything is hard to understand,
                  please ask you parent/guardian to explain. If you still have
                  any questions, you or your parent/guardian can contact us at:
                ...
                <p className="px-5">
                  <ul className="list-outside list-disc px-5">
                    ...
                    <li>
                      ...
                      <Link href="/"> www.tefzon.com</Link>. You must draw their
                      attention to these terms which also apply to them; and
                    </li>
                    <li>
                      You may provide links to the Website provided they go to
                      the home page only and provided you do so in a way that is
            ...
            <div className="tab w-full overflow-hidden border-t">
              ...
              <div className="tab-content overflow-hidden border-l-2 bg-gray-100 border-indigo-500 leading-normal">
                ...
                <p className="px-5 pb-5">
                  If you are under 18, you may need your parent/guardian to help
                  you with your use of the Website and the App and with ensuring
                  the content and availability of any linked websites and
            ...
            <div className="tab w-full overflow-hidden border-t">
              ...
              <div className="tab-content overflow-hidden border-l-2 bg-gray-100 border-indigo-500 leading-normal">
                <p className="p-5">
                  ...
                  authorities and will co-operate with those authorities by
            ...
            <div className="tab w-full overflow-hidden border-t">
              ...
              <div className="tab-content overflow-hidden border-l-2 bg-gray-100 border-indigo-500 leading-normal">
                <p className="p-5">
                  We exclude all liability to you in respect of your use of the
                  Website and App.
                </p>
              </div>
            </div>
