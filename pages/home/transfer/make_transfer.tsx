  ...
  return (
    <MainLayout>
      ...
      <div className="container  mx-auto   lg:px-2 lg:flex">
        ...
        <div className="container max-w-sm bg-white rounded-xl   shadow-indigo-500/50 md:w-3/5 sm:ml-12 mt-10 mb-20    w-auto">
          <div className="px-1">
            <div className="p-5 w-full pb-10 ">
              <h1 className="font-semibold text-xl text-gray-700 py-3 ">
                Player Selection
              </h1>

              <div className="w-full  flex-1 svelte-1l8159u">
                <div className="block relative flex items-center mt-4 md:mt-0">
              ...
              <div className="w-full  flex-1 svelte-1l8159u mt-2">
