  ...
  return isLoading ? (
    ...
    <GuestLayout>
      <div className="container px-12 py-2 mx-auto ">
        <div className="z-0 md:flex shadow-2xl rounded-xl shadow-indigo-500/50 px-10 lg:px-20 h-3/4">
          <div className="mt-20 mb-12 md:w-3/5">
            <h2 className="mb-4 md:text-5xl font-bold leading-tight tracking-tighter text-gray-800 font-oswald animate-fade-in-up">
